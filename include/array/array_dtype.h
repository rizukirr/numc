#ifndef NUMC_ARRAY_DTYPE_H
#define NUMC_ARRAY_DTYPE_H
...
static const size_t numc_type_align[] = {
    [NUMC_DTYPE_INT8] = ARENA_ALIGNOF(NUMC_INT8),
    [NUMC_DTYPE_INT16] = ARENA_ALIGNOF(NUMC_INT16),
    [NUMC_DTYPE_INT32] = ARENA_ALIGNOF(NUMC_INT32),
    [NUMC_DTYPE_INT64] = ARENA_ALIGNOF(NUMC_INT64),
    [NUMC_DTYPE_UINT8] = ARENA_ALIGNOF(NUMC_UINT8),
    [NUMC_DTYPE_UINT16] = ARENA_ALIGNOF(NUMC_UINT16),
    [NUMC_DTYPE_UINT32] = ARENA_ALIGNOF(NUMC_UINT32),
    [NUMC_DTYPE_UINT64] = ARENA_ALIGNOF(NUMC_UINT64),
    [NUMC_DTYPE_FLOAT32] = ARENA_ALIGNOF(NUMC_FLOAT32),
    [NUMC_DTYPE_FLOAT64] = ARENA_ALIGNOF(NUMC_FLOAT64),
};
