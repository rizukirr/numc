...
#define STAMP_CMPSC_F32_AVX2(NAME, IMM)                                \
  static inline void _cmpsc_##NAME##_f32_avx2(                         \
...
#define CMPSC_F64_FUNC(NAME, IMM, SCALAR_OP)                          \
  static inline void _cmpsc_##NAME##_f64_avx2(                        \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
...
#define STAMP_CMPSC_SINT_AVX2(SFX, CT, VPV, SET1, CMPEQ, CMPGT)       \
  static inline void _cmpsc_eq_##SFX##_avx2(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
  ...
  static inline void _cmpsc_gt_##SFX##_avx2(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_lt_##SFX##_avx2(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_ge_##SFX##_avx2(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_le_##SFX##_avx2(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
...
STAMP_CMPSC_SINT_AVX2(i8, int8_t, 32, _mm256_set1_epi8,
                       _mm256_cmpeq_epi8, _mm256_cmpgt_epi8)
STAMP_CMPSC_SINT_AVX2(i16, int16_t, 16, _mm256_set1_epi16,
                       _mm256_cmpeq_epi16, _mm256_cmpgt_epi16)
STAMP_CMPSC_SINT_AVX2(i32, int32_t, 8, _mm256_set1_epi32,
                       _mm256_cmpeq_epi32, _mm256_cmpgt_epi32)
STAMP_CMPSC_SINT_AVX2(i64, int64_t, 4, _mm256_set1_epi64x,
                       _mm256_cmpeq_epi64, _mm256_cmpgt_epi64)
...
STAMP_CMPSC_UINT_AVX2(u8, uint8_t, 32, _mm256_set1_epi8,
                       _mm256_cmpeq_epi8, _mm256_cmpgt_epi8,
                       _mm256_set1_epi8((char)0x80))
STAMP_CMPSC_UINT_AVX2(u16, uint16_t, 16, _mm256_set1_epi16,
                       _mm256_cmpeq_epi16, _mm256_cmpgt_epi16,
                       _mm256_set1_epi16((short)0x8000))
STAMP_CMPSC_UINT_AVX2(u32, uint32_t, 8, _mm256_set1_epi32,
                       _mm256_cmpeq_epi32, _mm256_cmpgt_epi32,
                       _mm256_set1_epi32((int)0x80000000))
STAMP_CMPSC_UINT_AVX2(u64, uint64_t, 4, _mm256_set1_epi64x,
                       _mm256_cmpeq_epi64, _mm256_cmpgt_epi64,
