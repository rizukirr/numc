...
FAST_SC_INT_AVX512(add, i8, int8_t, 64,
                   _mm512_set1_epi8, _mm512_add_epi8, +)
FAST_SC_INT_AVX512(add, i16, int16_t, 32,
                   _mm512_set1_epi16, _mm512_add_epi16, +)
FAST_SC_INT_AVX512(add, i32, int32_t, 16,
                   _mm512_set1_epi32, _mm512_add_epi32, +)
FAST_SC_INT_AVX512(add, i64, int64_t, 8,
                   _mm512_set1_epi64, _mm512_add_epi64, +)
FAST_SC_INT_AVX512(add, u8, uint8_t, 64,
                   _mm512_set1_epi8, _mm512_add_epi8, +)
FAST_SC_INT_AVX512(add, u16, uint16_t, 32,
                   _mm512_set1_epi16, _mm512_add_epi16, +)
FAST_SC_INT_AVX512(add, u32, uint32_t, 16,
                   _mm512_set1_epi32, _mm512_add_epi32, +)
FAST_SC_INT_AVX512(add, u64, uint64_t, 8,
                   _mm512_set1_epi64, _mm512_add_epi64, +)
...
FAST_SC_INT_AVX512(sub, i8, int8_t, 64,
                   _mm512_set1_epi8, _mm512_sub_epi8, -)
FAST_SC_INT_AVX512(sub, i16, int16_t, 32,
                   _mm512_set1_epi16, _mm512_sub_epi16, -)
FAST_SC_INT_AVX512(sub, i32, int32_t, 16,
                   _mm512_set1_epi32, _mm512_sub_epi32, -)
FAST_SC_INT_AVX512(sub, i64, int64_t, 8,
                   _mm512_set1_epi64, _mm512_sub_epi64, -)
FAST_SC_INT_AVX512(sub, u8, uint8_t, 64,
                   _mm512_set1_epi8, _mm512_sub_epi8, -)
FAST_SC_INT_AVX512(sub, u16, uint16_t, 32,
                   _mm512_set1_epi16, _mm512_sub_epi16, -)
FAST_SC_INT_AVX512(sub, u32, uint32_t, 16,
                   _mm512_set1_epi32, _mm512_sub_epi32, -)
FAST_SC_INT_AVX512(sub, u64, uint64_t, 8,
                   _mm512_set1_epi64, _mm512_sub_epi64, -)
...
FAST_SC_INT_AVX512(mul, i16, int16_t, 32,
                   _mm512_set1_epi16, _mm512_mullo_epi16, *)
FAST_SC_INT_AVX512(mul, i32, int32_t, 16,
                   _mm512_set1_epi32, _mm512_mullo_epi32, *)
FAST_SC_INT_AVX512(mul, u16, uint16_t, 32,
                   _mm512_set1_epi16, _mm512_mullo_epi16, *)
FAST_SC_INT_AVX512(mul, u32, uint32_t, 16,
                   _mm512_set1_epi32, _mm512_mullo_epi32, *)

/* ── Mul scalar i8: widening trick (no native 8-bit multiply) ──── */

static inline void _fast_mul_scalar_i8_avx512(
    const void *restrict ap, const void *restrict sp,
    void *restrict op, size_t n) {
...
static inline void _fast_mul_scalar_u8_avx512(
    const void *restrict ap, const void *restrict sp,
    void *restrict op, size_t n) {
...
static inline void _fast_mul_scalar_i64_avx512(
    const void *restrict ap, const void *restrict sp,
    void *restrict op, size_t n) {
...
static inline void _fast_mul_scalar_u64_avx512(
    const void *restrict ap, const void *restrict sp,
    void *restrict op, size_t n) {
