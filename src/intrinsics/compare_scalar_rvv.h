...
#define STAMP_CMPSC_SINT_RVV(SFX, CT, SEW, LMUL, RATIO)               \
  static inline void _cmpsc_eq_##SFX##_rvv(                           \
  ...
  static inline void _cmpsc_gt_##SFX##_rvv(                           \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_lt_##SFX##_rvv(                           \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_ge_##SFX##_rvv(                           \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_le_##SFX##_rvv(                           \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
...
#define STAMP_CMPSC_FLOAT_RVV(SFX, CT, SEW, LMUL, RATIO)              \
  static inline void _cmpsc_eq_##SFX##_rvv(                           \
    ...
    for (size_t i = 0; i < n; i += vl) {                               \
      ...
      vfloat##SEW##m##LMUL##_t r =                                    \
          __riscv_vfmerge_vfm_f##SEW##m##LMUL(                         \
              __riscv_vfmv_v_f_f##SEW##m##LMUL((CT)0, vl),            \
              (CT)1, mask, vl);                                        \
