...
#define FAST_BIN_SINT_RVV(OP, SFX, CT, SEW, VEC_OP)                     \
  static inline void _fast_##OP##_##SFX##_rvv(                          \
    ...
    for (size_t i = 0; i < n; i += vl) {                                 \
      ...
      vint##SEW##m4_t vb =                                               \
          __riscv_vle##SEW##_v_i##SEW##m4(b + i, vl);                    \
...
#define FAST_BIN_UINT_RVV(OP, SFX, CT, SEW, VEC_OP)                     \
  static inline void _fast_##OP##_##SFX##_rvv(                          \
    ...
    for (size_t i = 0; i < n; i += vl) {                                 \
      ...
      vuint##SEW##m4_t vb =                                              \
          __riscv_vle##SEW##_v_u##SEW##m4(b + i, vl);                    \
...
#define FAST_BIN_F32_RVV(OP, VEC_OP)                                    \
  static inline void _fast_##OP##_f32_rvv(                              \
      const void *restrict ap, const void *restrict bp,                  \
      void *restrict op, size_t n) {                                     \
...
#define FAST_BIN_F64_RVV(OP, VEC_OP)                                    \
  static inline void _fast_##OP##_f64_rvv(                              \
      const void *restrict ap, const void *restrict bp,                  \
      void *restrict op, size_t n) {                                     \
...
#define FAST_NEG_SINT_RVV(SFX, CT, SEW)                                 \
  static inline void _fast_neg_##SFX##_rvv(                             \
    ...
    for (size_t i = 0; i < n; i += vl) {                                 \
      ...
      __riscv_vse##SEW##_v_i##SEW##m4(                                   \
          out + i, __riscv_vneg_v_i##SEW##m4(va, vl), vl);               \
    }                                                                    \
  }
...
static inline void _fast_neg_f32_rvv(const void *restrict ap,
                                     void *restrict op, size_t n) {
  const float *a = (const float *)ap;
  float *out = (float *)op;
  size_t vl;
...
static inline void _fast_neg_f64_rvv(const void *restrict ap,
                                     void *restrict op, size_t n) {
  const double *a = (const double *)ap;
  double *out = (double *)op;
  size_t vl;
...
#define FAST_ABS_SINT_RVV(SFX, CT, SEW)                                 \
  static inline void _fast_abs_##SFX##_rvv(                             \
      const void *restrict ap, void *restrict op, size_t n) {           \
    const CT *a = (const CT *)ap;                                        \
    CT *out = (CT *)op;                                                  \
    size_t vl;                                                           \
    for (size_t i = 0; i < n; i += vl) {                                 \
      ...
      vint##SEW##m4_t va =                                               \
          __riscv_vle##SEW##_v_i##SEW##m4(a + i, vl);                    \
      vint##SEW##m4_t neg =                                              \
          __riscv_vneg_v_i##SEW##m4(va, vl);                             \
      __riscv_vse##SEW##_v_i##SEW##m4(                                   \
          out + i,                                                       \
          __riscv_vmax_vv_i##SEW##m4(va, neg, vl), vl);                  \
    }                                                                    \
  }
...
static inline void _fast_abs_f32_rvv(const void *restrict ap,
                                     void *restrict op, size_t n) {
  const float *a = (const float *)ap;
  float *out = (float *)op;
  size_t vl;
...
static inline void _fast_abs_f64_rvv(const void *restrict ap,
                                     void *restrict op, size_t n) {
  const double *a = (const double *)ap;
  double *out = (double *)op;
  size_t vl;
