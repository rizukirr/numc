...
FAST_SCAL_INT_AVX2(add, i8, int8_t, 32, _mm256_set1_epi8, _mm256_add_epi8,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, i16, int16_t, 16, _mm256_set1_epi16, _mm256_add_epi16,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, i32, int32_t, 8, _mm256_set1_epi32, _mm256_add_epi32,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, i64, int64_t, 4, _mm256_set1_epi64x, _mm256_add_epi64,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, u8, uint8_t, 32, _mm256_set1_epi8, _mm256_add_epi8,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, u16, uint16_t, 16, _mm256_set1_epi16, _mm256_add_epi16,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, u32, uint32_t, 8, _mm256_set1_epi32, _mm256_add_epi32,
                   a[i] + s)
FAST_SCAL_INT_AVX2(add, u64, uint64_t, 4, _mm256_set1_epi64x, _mm256_add_epi64,
                   a[i] + s)
...
FAST_SCAL_INT_AVX2(sub, i8, int8_t, 32, _mm256_set1_epi8, _mm256_sub_epi8,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, i16, int16_t, 16, _mm256_set1_epi16, _mm256_sub_epi16,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, i32, int32_t, 8, _mm256_set1_epi32, _mm256_sub_epi32,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, i64, int64_t, 4, _mm256_set1_epi64x, _mm256_sub_epi64,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, u8, uint8_t, 32, _mm256_set1_epi8, _mm256_sub_epi8,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, u16, uint16_t, 16, _mm256_set1_epi16, _mm256_sub_epi16,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, u32, uint32_t, 8, _mm256_set1_epi32, _mm256_sub_epi32,
                   a[i] - s)
FAST_SCAL_INT_AVX2(sub, u64, uint64_t, 4, _mm256_set1_epi64x, _mm256_sub_epi64,
                   a[i] - s)
...
FAST_SCAL_INT_AVX2(mul, i16, int16_t, 16, _mm256_set1_epi16, _mm256_mullo_epi16,
                   a[i] * s)
FAST_SCAL_INT_AVX2(mul, i32, int32_t, 8, _mm256_set1_epi32, _mm256_mullo_epi32,
                   a[i] * s)
FAST_SCAL_INT_AVX2(mul, u16, uint16_t, 16, _mm256_set1_epi16,
                   _mm256_mullo_epi16, a[i] * s)
...
static inline void _fast_mul_scalar_u8_avx2(const void *restrict ap,
  ...
  const __m256i vs_hi = _mm256_srli_epi16(_mm256_set1_epi8((char)s), 8);
  size_t i = 0;
  for (; i + 32 <= n; i += 32) {
    __m256i va = _mm256_loadu_si256((const __m256i *)(a + i));
    __m256i lo = _mm256_and_si256(
