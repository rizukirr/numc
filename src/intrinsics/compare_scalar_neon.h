...
#define STAMP_CMPSC_SINT_NEON(SFX, CT, W, VPV)                        \
  static inline void _cmpsc_eq_##SFX##_neon(                          \
  ...
  static inline void _cmpsc_gt_##SFX##_neon(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_lt_##SFX##_neon(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_ge_##SFX##_neon(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
  ...
  static inline void _cmpsc_le_##SFX##_neon(                          \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
    const CT *a = (const CT *)ap;                                      \
    const CT s = *(const CT *)sp;                                      \
...
#define CMPSC_F32_NEON(NAME, CMP)                                      \
  static inline void _cmpsc_##NAME##_f32_neon(                         \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
...
static inline int eq_scalar_f32(float a, float b) { return a == b; }
static inline int gt_scalar_f32(float a, float b) { return a > b; }
static inline int lt_scalar_f32(float a, float b) { return a < b; }
static inline int ge_scalar_f32(float a, float b) { return a >= b; }
static inline int le_scalar_f32(float a, float b) { return a <= b; }
...
#define CMPSC_F64_NEON(NAME, CMP)                                      \
  static inline void _cmpsc_##NAME##_f64_neon(                         \
      const void *restrict ap, const void *restrict sp,                \
      void *restrict op, size_t n) {                                   \
...
static inline int eq_scalar_f64(double a, double b) { return a == b; }
static inline int gt_scalar_f64(double a, double b) { return a > b; }
static inline int lt_scalar_f64(double a, double b) { return a < b; }
static inline int ge_scalar_f64(double a, double b) { return a >= b; }
static inline int le_scalar_f64(double a, double b) { return a <= b; }
