...
static inline float _sin_f32(float x) {
  ...
  float sp =
      r * (1.0f + r2 * (s1 + r2 * (s2 + r2 * (s3 + r2 * (s4 + r2 * s5)))));
  float cp = 1.0f - 0.5f * r2 +
             r2 * r2 * (c1 + r2 * (c2 + r2 * (c3 + r2 * (c4 + r2 * c5))));
...
static inline float _cos_f32(float x) {
  static const float s1 = -1.6666654611e-01f, s2 = 8.3321608736e-03f,
                     s3 = -1.9515295891e-04f, s4 = 2.7557385942e-06f,
                     s5 = -2.5050747676e-08f;
  static const float c1 = 4.1666667908e-02f, c2 = -1.3888889225e-03f,
                     c3 = 2.4801587642e-05f, c4 = -2.7557314297e-07f,
                     c5 = 2.0875723372e-09f;
  static const float pio2_hi = 1.5703125000f, pio2_lo = 4.8367738724e-04f,
                     fopi = 6.3661977237e-01f;
...
static inline double _sin_f64(double x) {
  ...
  double sp =
      ...
      (1.0 +
       r2 * (s1 +
             r2 * (s2 +
                   r2 * (s3 + r2 * (s4 + r2 * (s5 + r2 * (s6 + r2 * s7)))))));
  double cp =
      1.0 - 0.5 * r2 +
      r2 * r2 *
          (c1 +
           r2 * (c2 + r2 * (c3 + r2 * (c4 + r2 * (c5 + r2 * (c6 + r2 * c7))))));
