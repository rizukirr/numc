...
int main() {
  ...
  /* 5. High-D Dot: (2, 3) . (4, 3, 5) -> (2, 4, 5) */
  {
    ...
    size_t s_o[] = {2, 4, 5};
    NumcArray *a =
        numc_array_fill(ctx, s_a, 2, NUMC_DTYPE_FLOAT32, &(float){1.0f});
    NumcArray *b =
        numc_array_fill(ctx, s_b, 3, NUMC_DTYPE_FLOAT32, &(float){1.0f});
