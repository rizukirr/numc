...
static int test_rand_float32_not_all_zero(void) {
  ...
  NumcArray *a =
      numc_array_rand(ctx, (size_t[]){64}, 1, NUMC_DTYPE_FLOAT32);
  ASSERT_MSG(a != NULL, "rand float32 must not be NULL");
...
static int test_rand_float64_range(void) {
  ...
  NumcArray *a =
      numc_array_rand(ctx, (size_t[]){1024}, 1, NUMC_DTYPE_FLOAT64);
  ASSERT_MSG(a != NULL, "rand float64 must not be NULL");

  double *p = (double *)numc_array_data(a);
  for (size_t i = 0; i < 1024; i++) {
    ASSERT_MSG(p[i] >= 0.0 && p[i] < 1.0,
               "rand float64 must be in [0, 1)");
  }
...
static int test_rand_int32_not_uniform_zero(void) {
  ...
  NumcArray *a =
      numc_array_rand(ctx, (size_t[]){64}, 1, NUMC_DTYPE_INT32);
...
static int test_rand_uint8_range(void) {
  ...
  NumcArray *a =
      numc_array_rand(ctx, (size_t[]){256}, 1, NUMC_DTYPE_UINT8);
...
static int test_rand_2d(void) {
  ...
  NumcArray *a =
      numc_array_rand(ctx, (size_t[]){4, 8}, 2, NUMC_DTYPE_FLOAT32);
...
static int test_rand_3d(void) {
  ...
  for (size_t i = 0; i < 24; i++) {
    ASSERT_MSG(p[i] >= 0.0 && p[i] < 1.0,
               "rand 3D float64 must be in [0, 1)");
  }
...
static int test_rand_null_ctx(void) {
  NumcArray *a =
      numc_array_rand(NULL, (size_t[]){4}, 1, NUMC_DTYPE_FLOAT32);
...
static int test_rand_zero_dim(void) {
  NumcCtx *ctx = numc_ctx_create();
  NumcArray *a =
      numc_array_rand(ctx, (size_t[]){4}, 0, NUMC_DTYPE_FLOAT32);
